...
namespace CapaAccesoDatosProductos.Migrations
{
    ...
    [Migration("20200504215721_ProductoApi")]
    partial class ProductoApi
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CapaDominioProductos.Entidades.CategoriaProducto", b =>
                {
            ...
            modelBuilder.Entity("CapaDominioProductos.Entidades.Producto", b =>
                {
                    ...
                    b.Property<int?>("MarcaNavigatorMarcaID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MarcaNavigatorMarcaID");
            ...
            modelBuilder.Entity("CapaDominioProductos.Entidades.CategoriaProducto", b =>
                {
                    ...
                    b.HasOne("CapaDominioProductos.Entidades.Producto", "ProductoNavigator")
                        .WithOne("CategoriaProductoNavigator")
                        .HasForeignKey("CapaDominioProductos.Entidades.CategoriaProducto", "ProductoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CapaDominioProductos.Entidades.Producto", b =>
                {
                    ...
                    b.HasOne("CapaDominioProductos.Entidades.Marca", "MarcaNavigator")
                        .WithMany()
                        .HasForeignKey("MarcaNavigatorMarcaID");
